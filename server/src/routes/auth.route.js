...
const { controllerAuthGoogle, controllerInsertUser, controllerVerifyUserCredentials, controllerFetchLoggedInUser } = require("../controllers/user.controller");
...
authRouter.get("/google/callback", passportInstance.authenticate("google", { failureRedirect: "/register" }), controllerAuthGoogle);
